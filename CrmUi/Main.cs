...
namespace CrmUi
{
    public partial class Main : Form
    {
        ...
        private void UpdateLists()
        {
            ...
            label1.Text = $"The total cost: {cart.Price}$";
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(customer != null)
            {
                ...
                MessageBox.Show("Purchase completed successfully. Sum :" + price, "Purchase completed", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
